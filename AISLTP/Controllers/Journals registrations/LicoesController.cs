...
namespace AISLTP.Controllers.Journals_registrations
{
    public class LicoesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ID,Fam,Ima,Otc,Dr,PolID,Pasport,NacID,OblID,RnID,NpID,Ul,Dom,Korpus,Kvartira,Vneshnost")] Lico lico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ID,Fam,Ima,Otc,Dr,PolID,Pasport,NacID,OblID,RnID,NpID,Ul,Dom,Korpus,Kvartira,Vneshnost")] Lico lico)
        {
            if (ModelState.IsValid)
            {
